    ...
    out float4 o0: SV_Target0)
{
    ...
    r0.xy = (int2)v0.xy;
    r0.zw = float2(0, 0);
    r0.xyzw = g_Texture0.Load(r0.xyz).xyzw;
    r1.xyzw = g_ImageTexture.Sample(g_ImageTextureSampler_s, v1.xy).xyzw;
    r2.xyzw = materialColor.yzwx * r1.yzwx;
    r1.w = r2.z;
    switch (filterType_) {
    case 0: r3.xyz = r1.xyz * materialColor.xyz + -r0.xyz;
        o0.xyz = r1.www * r3.xyz + r0.xyz;
        o0.w = 1;
        return;
    case 1: r3.xyz = min(r2.wxy, r0.xyz);
        r3.xyz = r3.xyz + -r0.xyz;
        o0.xyz = r1.www * r3.xyz + r0.xyz;
        o0.w = r0.w;
        return;
    case 2: o0.xyz = r2.wxy * r0.xyz;
        o0.w = 1;
        return;
    case 3: r3.xyz = cmp(r2.wxy == float3(0, 0, 0));
        ...
        o0.w = r0.w;
        return;
    case 4: r3.xyz = r1.xyz * materialColor.xyz + r0.xyz;
        ...
        o0.w = r0.w;
        return;
    case 5: r3.x = dot(r0.xyz, float3(0.300000012, 0.589999974, 0.109999999));
        ...
        o0.w = r0.w;
        return;
    case 6: r3.xyz = max(r2.wxy, r0.xyz);
        r3.xyz = r3.xyz + -r0.xyz;
        o0.xyz = r1.www * r3.xyz + r0.xyz;
        o0.w = r0.w;
        return;
    case 7: r3.xyz = float3(1, 1, 1) + -r0.xyz;
        ...
        o0.w = r0.w;
        return;
    case 8: r3.xyz = cmp(r2.wxy == float3(1, 1, 1));
        r4.xyz = -r1.xyz * materialColor.xyz + float3(1, 1, 1);
        ...
        o0.w = r0.w;
        return;
    case 9: o0.xyz = r1.www * r2.wxy + r0.xyz;
        o0.w = r0.w;
        return;
    case 10: r3.x = dot(r0.xyz, float3(0.300000012, 0.589999974, 0.109999999));
        r3.y = dot(r2.wxy, float3(0.300000012, 0.589999974, 0.109999999));
        r3.x = cmp(r3.y < r3.x);
        r3.xyz = r3.xxx ? r0.xyz : r2.wxy;
        r3.xyz = r3.xyz + -r0.xyz;
        ...
        o0.w = r0.w;
        return;
    case 11: r3.xyz = cmp(r0.xyz < float3(0.5, 0.5, 0.5));
        ...
        o0.w = r0.w;
        return;
    case 12: r3.xyz = cmp(r2.wxy < float3(0.5, 0.5, 0.5));
        ...
        o0.w = r0.w;
        return;
    case 13: r3.xyz = cmp(r2.wxy < float3(0.5, 0.5, 0.5));
        ...
        o0.w = r0.w;
        return;
    case 14: r3.xyz = cmp(r2.wxy < float3(0.5, 0.5, 0.5));
        ...
        o0.w = r0.w;
        return;
    case 15: r3.xyz = cmp(r2.wxy < float3(0.5, 0.5, 0.5));
        ...
        o0.w = r0.w;
        return;
    case 16: r3.xyz = cmp(r2.wxy < float3(0.5, 0.5, 0.5));
        r4.xyz = r2.wxy + r2.wxy;
        ...
        o0.w = r0.w;
        return;
    case 17: r3.xyz = cmp(r2.wxy < float3(0.5, 0.5, 0.5));
        r4.xyz = r2.wxy + r2.wxy;
        r5.xyz = cmp(r2.wxy == float3(0, 0, 0));
        r6.xyz = float3(1, 1, 1) + -r0.xyz;
        r6.xyz = r6.xyz / r4.xyz;
        ...
        o0.w = r0.w;
        return;
    case 18: r3.xyz = -r1.xyz * materialColor.xyz + r0.xyz;
        r3.xyz = abs(r3.xyz) + -r0.xyz;
        o0.xyz = r1.www * r3.xyz + r0.xyz;
        o0.w = r0.w;
        return;
    case 19: r3.xyz = r1.xyz * materialColor.xyz + r0.xyz;
        ...
        o0.w = r0.w;
        return;
    case 20: r3.xyz = -r1.xyz * materialColor.xyz + r0.xyz;
        r3.xyz = max(float3(0, 0, 0), r3.xyz);
        r3.xyz = r3.xyz + -r0.xyz;
        o0.xyz = r1.www * r3.xyz + r0.xyz;
        o0.w = r0.w;
        return;
    case 21: r1.xyz = r1.xyz * materialColor.xyz + float3(9.99999997e-07, 9.99999997e-07, 9.99999997e-07);
        r1.xyz = r0.xyz / r1.xyz;
        r1.xyz = r1.xyz + -r0.xyz;
        o0.xyz = r1.www * r1.xyz + r0.xyz;
        o0.w = r0.w;
        return;
    case 22: r1.x = cmp(r0.y < r0.z);
